...
class V1Ingress(object):
    ...
    @property
    def data(self):
        """Gets the data of this V1Ingress.  # noqa: E501
        ...
        :return: The data of this V1Ingress.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this V1Ingress.

        Data contains the secret data. Each key must consist of alphanumeric characters, '-', '_' or '.'. The serialized form of the secret data is a base64 encoded string, representing the arbitrary (possibly non-string) data value here. Described in https://tools.ietf.org/html/rfc4648#section-4  # noqa: E501

        :param data: The data of this V1Ingress.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def string_data(self):
        """Gets the string_data of this V1Ingress.  # noqa: E501
        ...
        :return: The string_data of this V1Ingress.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def string_data(self, string_data):
        """Sets the string_data of this V1Ingress.

        stringData allows specifying non-binary secret data in string form. It is provided as a write-only convenience method. All keys and values are merged into the data field on write, overwriting any existing values. It is never output when reading from the API.  # noqa: E501

        :param string_data: The string_data of this V1Ingress.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def type(self):
        """Gets the type of this V1Ingress.  # noqa: E501

        Used to facilitate programmatic handling of secret data.  # noqa: E501

        :return: The type of this V1Ingress.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this V1Ingress.

        Used to facilitate programmatic handling of secret data.  # noqa: E501

        :param type: The type of this V1Ingress.  # noqa: E501
        :type: str
        """
